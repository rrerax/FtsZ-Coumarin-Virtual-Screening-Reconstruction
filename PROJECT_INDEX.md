...
| 5 | `docs/enopt_extension.md` | EnOpt-style receptor-ensemble reranking note |
| 6 | `docs/data_availability.md` | Raw-input layout for complete local reruns |
...
| EnOpt-style reranking plot | `results/figures/enopt_style_reranking_vs_legacy.png` |
| Conformation score matrix heatmap | `results/figures/ensemble_score_matrix_heatmap.png` |
| EnOpt-style conformation weights | `results/figures/enopt_style_conformation_weights.png` |
| Full Vina rerun table | `results/tables/vina_rerun_unique_structures.csv` |
| Ensemble docking score table | `results/tables/ensemble_vina_scores.csv` |
| EnOpt-style top-hit table | `results/tables/enopt_style_top_hits.csv` |
